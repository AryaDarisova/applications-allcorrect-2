                        ...
                        <div className="row">
                            <div className="col-sm-1 form-check">
                                <input type="checkbox" className="form-check-input"
                                       ...
                                       onChange={() => props.clearLanguagesFunc("appStore")} style={styles.inputCheckbox}/>
                            </div>
                            ...
                            <div className="col-sm-2">
                                <input
                                    ...
                                    id="inputAppStoreClearLanguagesPercent"
                                    name="inputAppStoreClearLanguagesPercent"
                                    defaultValue={props.languageClearPercent}
                                    onChange={e => props.setClearLanguagesPercent("appStore", e.target.value)}
